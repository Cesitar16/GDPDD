...
Esta sección incorpora la planificación integrada elaborada por Fabián Leal. Traduce la línea base técnica D1--D6 y el TCO D7--D11 en un plan ejecutable y trazable \parencite{fabian-planificacion}. El cierre selecciona Cloud/GCP como arquitectura del piloto, con TCO oficial de \$10.815.487 CLP a 36 meses. La ejecución de esta planificación queda condicionada a los gates éticos CA-E01 a CA-E10, autorización y gobierno de datos aplicables, controles técnicos y de seguridad, aceptación de riesgos y validación local. Distingue dos horizontes: un piloto de implementación de 10 semanas y una operación financiera y de gobierno de 36 meses. El piloto de 10 semanas es un supuesto de planificación; el horizonte de 36 meses incluye ingesta batch diaria, RTO de 8 h, RPO de 24 h y seis ventanas semestrales de evaluación y eventual reentrenamiento.
