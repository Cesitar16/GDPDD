...
Este anexo completa la trazabilidad de planificación de Fabián Leal para la EDT, la Carta Gantt, los gates, dependencias, recursos y riesgos \parencite{fabian-planificacion}. Cloud/GCP es la arquitectura seleccionada para el piloto; su ejecución queda condicionada a los gates éticos CA-E01 a CA-E10, legales, técnicos, de seguridad, de riesgos y de validación local.
